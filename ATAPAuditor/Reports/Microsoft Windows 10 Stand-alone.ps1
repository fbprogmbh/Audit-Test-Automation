	...
	Sections = @(
		[ReportSection] @{
			...
			SubSections = @(
				[ReportSection] @{
					...
					AuditInfos = Test-AuditGroup "MS Windows 10-Stand-alone-CIS-1.0.1#AccountPolicies"
				}
				[ReportSection] @{
					Title = 'Advanced Audit Policy Configuration'
					AuditInfos = Test-AuditGroup "MS Windows 10-Stand-alone-CIS-1.0.1#AuditPolicies"
				}
				[ReportSection] @{
					Title = 'Registry Settings/Group Policies'
					AuditInfos = Test-AuditGroup "MS Windows 10-Stand-alone-CIS-1.0.1#RegistrySettings"
				}
				[ReportSection] @{
					Title = 'Security Options'
					AuditInfos = Test-AuditGroup "MS Windows 10-Stand-alone-CIS-1.0.1#SecurityOptions"
				}
				[ReportSection] @{
					Title = 'User Rights Assignment'
					AuditInfos = Test-AuditGroup "MS Windows 10-Stand-alone-CIS-1.0.1#UserRights"
				}
			)
		}
		[ReportSection] @{
		...
		[ReportSection] @{
			...
			SubSections = @(
				[ReportSection] @{
					Title = 'Registry Settings/Group Policies'
					AuditInfos = Test-AuditGroup "MS Windows 10 SiSyPHuS NE-BSI-1.3#RegistrySettings"
				}
				[ReportSection] @{
					Title = 'User Rights Assignment'
					AuditInfos = Test-AuditGroup "MS Windows 10 SiSyPHuS NE-BSI-1.3#UserRights"
				}
				[ReportSection] @{
					Title = 'Account Policies'
					AuditInfos = Test-AuditGroup "MS Windows 10 SiSyPHuS NE-BSI-1.3#AccountPolicies"
				}
				[ReportSection] @{
					Title = 'Security Options'
					AuditInfos = Test-AuditGroup "MS Windows 10 SiSyPHuS NE-BSI-1.3#SecurityOptions"
				}
			)
		}	
		[ReportSection] @{
