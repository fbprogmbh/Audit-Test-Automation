...
[AuditTest] @{
    Id   = "2.3.11.8"
    Task = "(L1) Ensure 'Network security: LDAP client encryption requirements' is set to 1 - 'Negotiate sealing' or 2 - higher"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "5.5"
    Task = "(L2) Ensure 'GameInput Service (GameInputSvc)' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\GameInputSvc" `
                -Name "Start" `
            | Select-Object -ExpandProperty "Start"
...
[AuditTest] @{
    Id   = "5.36"
    Task = "(L2) Ensure 'WinHTTP Web Proxy Auto-Discovery Service (WinHttpAutoProxySvc)' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.6.4.1"
    Task = "(L1) Ensure 'Configure multicast DNS (mDNS) protocol' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.6.4.2"
    Task = "(L2) Ensure 'Turn off default IPv6 DNS Servers' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows NT\DNSClient" `
...
[AuditTest] @{
    Id   = "18.6.7.1"
    Task = "(L1) Ensure 'Audit client does not support encryption' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.6.7.2"
    Task = "(L1) Ensure 'Audit client does not support signing' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanServer" `
...
[AuditTest] @{
    Id   = "18.6.7.3"
    Task = "(L1) Ensure 'Audit insecure guest logon' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanServer" `
...
[AuditTest] @{
    Id   = "18.6.7.5"
    Task = "(L1) Ensure 'Enable remote mailslots' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.6.7.6"
    Task = "(L1) Ensure 'Mandate the minimum version of SMB' is set to 'Enabled: 3.1.1'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanServer" `
            ...
            if (($regValue -ne 785)) {
                return @{
                    Message = "Registry value is '$regValue'. Expected: x == 785"
                    Status  = "False"
                }
            }
        }
...
[AuditTest] @{
    Id   = "18.6.7.7"
    Task = "(L1) Ensure 'Set authentication rate limiter delay (milliseconds)' is set to 'Enabled: 2000' or more"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanServer" `
            ...
            if (($regValue -lt 2000)) {
                return @{
                    Message = "Registry value is '$regValue'. Expected: x >= 2000"
                    Status  = "False"
                }
            }
        }
...
[AuditTest] @{
    Id   = "18.6.8.2"
    Task = "(L1) Ensure 'Audit server does not support encryption' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanWorkstation" `
...
[AuditTest] @{
    Id   = "18.6.8.3"
    Task = "(L1) Ensure 'Audit server does not support signing' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanWorkstation" `
...
[AuditTest] @{
    Id   = "18.6.8.7"
    Task = "(L1) Ensure 'Require Encryption' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LanmanWorkstation" `
...
[AuditTest] @{
    Id   = "18.7.6"
    Task = "(L1) Ensure 'Configure RPC listener settings: Authentication protocol to use for incoming RPC connections:' is set to 0 - 'Enabled: Negotiate' or 1 - higher"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\Printers\RPC" `
...
[AuditTest] @{
    Id   = "18.7.9"
    Task = "(L2) Ensure 'Configure Windows protected print' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\Printers\WPP" `
                -Name "WindowsProtectedPrintGroupPolicyState" `
            | Select-Object -ExpandProperty "WindowsProtectedPrintGroupPolicyState"
...
[AuditTest] @{
    Id   = "18.8.2"
    Task = "(L2) Ensure 'Remove Personalized Website Recommendations from the Recommended section in the Start Menu' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Explorer" `
                -Name "HideRecommendedPersonalizedSites" `
            | Select-Object -ExpandProperty "HideRecommendedPersonalizedSites"
...
[AuditTest] @{
    Id   = "18.9.5.1"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.9.5.2"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security: Select Platform Security Level' is set to 1 - 'Secure Boot' or 3 - higher"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard" `
...
[AuditTest] @{
    Id   = "18.9.5.3"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security: Virtualization Based Protection of Code Integrity' is set to 'Enabled with UEFI lock'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard" `
...
[AuditTest] @{
    Id   = "18.9.5.4"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security: Require UEFI Memory Attributes Table' is set to 'True (checked)'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard" `
...
[AuditTest] @{
    Id   = "18.9.5.5"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security: Credential Guard Configuration' is set to 'Enabled with UEFI lock'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard" `
...
[AuditTest] @{
    Id   = "18.9.5.6"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security: Secure Launch Configuration' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard" `
...
[AuditTest] @{
    Id   = "18.9.5.7"
    Task = "(L1) Ensure 'Turn On Virtualization Based Security: Kernel-mode Hardware-enforced Stack Protection' is set to 'Enabled: Enabled in enforcement mode'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard" `
...
[AuditTest] @{
    Id   = "18.9.27.1"
    Task = "(L2) Ensure 'Disallow copying of user input methods to the system account for signin' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.9.52"
    Task = "(L1) Ensure 'Configure the behavior of the sudo command' is set to 'Enabled: Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.3.1"
    Task = "(L2) Ensure 'Turn off API Sampling' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\AppCompat" `
                -Name "DisableAPISamping" `
            | Select-Object -ExpandProperty "DisableAPISamping"
...
[AuditTest] @{
    Id   = "18.10.3.2"
    Task = "(L2) Ensure 'Turn off Application Footprint' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\AppCompat" `
                -Name "DisableApplicationFootprint" `
            | Select-Object -ExpandProperty "DisableApplicationFootprint"
...
[AuditTest] @{
    Id   = "18.10.3.3"
    Task = "(L2) Ensure 'Turn off Install Tracing' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\AppCompat" `
                -Name "DisableInstallTracing" `
            | Select-Object -ExpandProperty "DisableInstallTracing"
...
[AuditTest] @{
    Id   = "18.10.4.2"
    Task = "(L1) Ensure 'Not allow per-user unsigned packages to install by default (requires explicitly allow per install)' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.10.1.4"
    Task = "(BL) Ensure 'Choose how BitLocker-protected fixed drives can be recovered: Recovery Password' is set to 2 - 'Enabled: Allow 48-digit recovery password' or 1 - higher"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\FVE" `
...
[AuditTest] @{
    Id   = "18.10.10.1.5"
    Task = "(BL) Ensure 'Choose how BitLocker-protected fixed drives can be recovered: Recovery Key' is set to 2 - 'Enabled: Allow 256-bit recovery key' or 1 - higher"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\FVE" `
...
[AuditTest] @{
    Id   = "18.10.14.1"
    Task = "(L1) Ensure 'Require pin for pairing' is set to 1 - 'Enabled: First Time' OR 2 - 'Enabled: Always'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.18.1"
    Task = "(L2) Ensure 'Enable App Installer' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.18.4"
    Task = "(L1) Ensure 'Enable App Installer Local Archive Malware Scan Override' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\AppInstaller" `
...
[AuditTest] @{
    Id   = "18.10.18.5"
    Task = "(L1) Ensure 'Enable App Installer Microsoft Store Source Certificate Validation Bypass' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\AppInstaller" `
...
[AuditTest] @{
    Id   = "18.10.18.7"
    Task = "(L2) Ensure 'Enable Windows Package Manager command line interfaces' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\AppInstaller" `
...
[AuditTest] @{
    Id   = "18.10.29.2"
    Task = "(L2) Ensure 'Turn off account-based insights, recent, favorite, and recommended files in File Explorer' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Explorer" `
...
[AuditTest] @{
    Id   = "18.10.29.4"
    Task = "(L1) Ensure 'Do not apply the Mark of the Web tag to files copied from insecure sources' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Explorer" `
...
[AuditTest] @{
    Id   = "18.10.44.1"
    Task = "(L1) Ensure 'Allow auditing events in Microsoft Defender Application Guard' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.44.2"
    Task = "(L1) Ensure 'Allow camera and microphone access in Microsoft Defender Application Guard' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI" `
...
[AuditTest] @{
    Id   = "18.10.44.3"
    Task = "(L1) Ensure 'Allow data persistence for Microsoft Defender Application Guard' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI" `
...
[AuditTest] @{
    Id   = "18.10.44.4"
    Task = "(L1) Ensure 'Allow files to download and save to the host operating system from Microsoft Defender Application Guard' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI" `
...
[AuditTest] @{
    Id   = "18.10.44.5"
    Task = "(L1) Ensure 'Configure Microsoft Defender Application Guard clipboard settings: Clipboard behavior setting' is set to 'Enabled: Enable clipboard operation from an isolated session to the host'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI" `
...
[AuditTest] @{
    Id   = "18.10.44.6"
    Task = "(L1) Ensure 'Turn on Microsoft Defender Application Guard in Managed Mode' is set to 'Enabled: 1'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI" `
...
[AuditTest] @{
    Id   = "18.10.57.2.2"
    Task = "(L2) Ensure 'Disable Cloud Clipboard integration for server-to-client data transfer' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.57.3.3.8"
    Task = "(L2) Ensure 'Restrict clipboard transfer from server to client' is set to 'Enabled: Disable clipboard transfers from server to client'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services" `
                -Name "SCClipLevel" `
            | Select-Object -ExpandProperty "SCClipLevel"
...
[AuditTest] @{
    Id   = "18.10.58.2"
    Task = "(L1) Ensure 'Turn on Basic feed authentication over HTTP' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Internet Explorer\Feeds" `
...
[AuditTest] @{
    Id   = "18.10.76.1.2"
    Task = "(L1) Ensure 'Notify Malicious' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\WTDS\Components" `
...
[AuditTest] @{
    Id   = "18.10.76.1.3"
    Task = "(L1) Ensure 'Notify Password Reuse' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\WTDS\Components" `
...
[AuditTest] @{
    Id   = "18.10.76.1.4"
    Task = "(L1) Ensure 'Notify Unsafe App' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\WTDS\Components" `
...
[AuditTest] @{
    Id   = "18.10.76.1.5"
    Task = "(L1) Ensure 'Service Enabled' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\WTDS\Components" `
...
[AuditTest] @{
    Id   = "18.10.79.1"
    Task = "(L1) Ensure 'Enable ESS with Supported Peripherals' is set to 'Enabled: 1'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
...
[AuditTest] @{
    Id   = "18.10.80.2"
    Task = "(L1) Ensure 'Allow Windows Ink Workspace' is set to 1 - 'Enabled: On, but disallow access above lock' OR 0 - 'Enabled: Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\WindowsInkWorkspace" `
...
[AuditTest] @{
    Id   = "18.10.82.1"
    Task = "(L1) Ensure 'Configure the transmission of the user's password in the content of MPR notifications sent by winlogon.' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Policies\System" `
...
[AuditTest] @{
    Id   = "18.10.91.2"
    Task = "(L2) Ensure 'Allow mapping folders into Windows Sandbox' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Sandbox" `
                -Name "AllowWriteToMappedFolders" `
            | Select-Object -ExpandProperty "AllowWriteToMappedFolders"
...
[AuditTest] @{
    Id   = "18.10.93.2.3"
    Task = "(L1) Ensure 'Enable features introduced via servicing that are off by default' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" `
                -Name "AllowTemporaryEnterpriseFeatureControl" `
            | Select-Object -ExpandProperty "AllowTemporaryEnterpriseFeatureControl"
...
[AuditTest] @{
    Id   = "18.10.93.4.4"
    Task = "(L1) Ensure 'Enable optional updates' is set to 'Disabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" `
                -Name "AllowOptionalContent" `
            | Select-Object -ExpandProperty "AllowOptionalContent"
...
[AuditTest] @{
    Id   = "19.7.40.1"
    Task = "(L1) Ensure 'Turn off Windows Copilot' is set to 'Enabled'"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
                -Path "Registry::HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Windows\WindowsCopilot" `
                -Name "TurnOffWindowsCopilot" `
            | Select-Object -ExpandProperty "TurnOffWindowsCopilot"
...
[AuditTest] @{
    Id   = "18.4.3 B"
    Task = "(L1) Ensure 'Enable Certificate Padding' is set to 'Enabled' (32-bit subsystem on 64-bit OS)"
    Test = {
        try {
            $regValue = Get-ItemProperty -ErrorAction Stop `
