...
[AuditTest] @{
    Id = "V-73413 + V-73415"
    Task = "Windows Server 2016 must be configured to audit Account Logon - Credential Validation successes. Windows Server 2016 must be configured to audit Account Logon - Credential Validation failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73417"
    Task = "Windows Server 2016 must be configured to audit Account Management - Computer Account Management successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73419"
    Task = "Windows Server 2016 must be configured to audit Account Management - Other Account Management Events successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73423"
    Task = "Windows Server 2016 must be configured to audit Account Management - Security Group Management successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73427 + V-73429"
    Task = "Windows Server 2016 must be configured to audit Account Management - User Account Management successes. Windows Server 2016 must be configured to audit Account Management - User Account Management failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73431"
    Task = "Windows Server 2016 must be configured to audit Detailed Tracking - Plug and Play Events successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73433"
    Task = "Windows Server 2016 must be configured to audit Detailed Tracking - Process Creation successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73435 + V-73437"
    Task = "Windows Server 2016 must be configured to audit DS Access - Directory Service Access successes. Windows Server 2016 must be configured to audit DS Access - Directory Service Access failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73439 + V-73441"
    Task = "Windows Server 2016 must be configured to audit DS Access - Directory Service Changes successes. Windows Server 2016 must be configured to audit DS Access - Directory Service Changes failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73443 + V-73445"
    Task = "Windows Server 2016 must be configured to audit Logon/Logoff - Account Lockout successes. Windows Server 2016 must be configured to audit Logon/Logoff - Account Lockout failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73447"
    Task = "Windows Server 2016 must be configured to audit Logon/Logoff - Group Membership successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73449"
    Task = "Windows Server 2016 must be configured to audit Logon/Logoff - Logoff successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73451 + V-73453"
    Task = "Windows Server 2016 must be configured to audit Logon/Logoff - Logon successes. Windows Server 2016 must be configured to audit Logon/Logoff - Logon failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73455"
    Task = "Windows Server 2016 must be configured to audit Logon/Logoff - Special Logon successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73457 + V-73459"
    Task = "Windows Server 2016 must be configured to audit Object Access - Removable Storage successes. Windows Server 2016 must be configured to audit Object Access - Removable Storage failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73461 + V-73463"
    Task = "Windows Server 2016 must be configured to audit Policy Change - Audit Policy Change successes. Windows Server 2016 must be configured to audit Policy Change - Audit Policy Change failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73465"
    Task = "Windows Server 2016 must be configured to audit Policy Change - Authentication Policy Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73467"
    Task = "Windows Server 2016 must be configured to audit Policy Change - Authorization Policy Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73469 + V-73471"
    Task = "Windows Server 2016 must be configured to audit Privilege Use - Sensitive Privilege Use successes. Windows Server 2016 must be configured to audit Privilege Use - Sensitive Privilege Use failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73473 + V-73475"
    Task = "Windows Server 2016 must be configured to audit System - IPsec Driver successes. Windows Server 2016 must be configured to audit System - IPsec Driver failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73477 + V-73479"
    Task = "Windows Server 2016 must be configured to audit System - Other System Events successes. Windows Server 2016 must be configured to audit System - Other System Events failures."
    Test = {
...
[AuditTest] @{
    Id = "V-73481"
    Task = "Windows Server 2016 must be configured to audit System - Security State Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73483"
    Task = "Windows Server 2016 must be configured to audit System - Security System Extension successes."
    Test = {
...
[AuditTest] @{
    Id = "V-73489 + V-73491"
    Task = "Windows Server 2016 must be configured to audit System - System Integrity successes. Windows Server 2016 must be configured to audit System - System Integrity failures."
    Test = {
...
[AuditTest] @{
    Id = "V-90359 + V-90361"
    Task = "Windows 2016 must be configured to audit Object Access - Other Object Access Events successes. Windows 2016 must be configured to audit Object Access - Other Object Access Events failures."
    Test = {
