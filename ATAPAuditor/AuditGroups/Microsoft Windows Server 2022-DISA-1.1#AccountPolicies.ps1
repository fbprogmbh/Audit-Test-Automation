[AuditTest] @{
    Id = "V-254285"
    Task = "Windows Server 2022 account lockout duration must be configured to 15  or greater."
    Test = {
...
[AuditTest] @{
    Id = "V-254286"
    Task = "Windows Server 2022 must have the number of allowed bad logon attempts configured to three or less."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254287"
    Task = "Windows Server 2022 must have the period of time before the bad logon counter is reset configured to 15  or greater."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254288"
    Task = "Windows Server 2022 password history must be configured to 24 passwords remembered."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254289"
    Task = "Windows Server 2022 maximum password age must be configured to 60  or less."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254290"
    Task = "Windows Server 2022 minimum password age must be configured to at least one day."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254291"
    Task = "Windows Server 2020 minimum password length must be configured to 14 characters."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254292"
    Task = "Windows Server 2022 must have the built-in Windows password complexity policy enabled."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
...
[AuditTest] @{
    Id = "V-254293"
    Task = "Windows Server 2022 reversible password encryption must be disabled."
    Test = {
        $securityPolicy = Get-AuditResource "WindowsSecurityPolicy"
