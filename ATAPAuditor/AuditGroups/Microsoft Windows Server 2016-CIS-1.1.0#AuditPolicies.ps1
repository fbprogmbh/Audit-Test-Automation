...
[AuditTest] @{
    Id = "17.2.3"
    Task = "(L1) Ensure 'Audit Distribution Group Management' is set to 'Success and Failure' (DC only)"
    Test = {
...
[AuditTest] @{
    Id = "17.4.1"
    Task = "(L1) Ensure 'Audit Directory Service Access' is set to 'Success and Failure' (DC only)"
    Test = {
...
[AuditTest] @{
    Id = "17.4.2"
    Task = "(L1) Ensure 'Audit Directory Service Changes' is set to 'Success and Failure' (DC only)"
    Test = {
