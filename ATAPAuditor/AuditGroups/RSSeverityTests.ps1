...
### Telemtry-checks
if((Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 10 Home Evaluation" -or 
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 10 Home" -or 
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 10 Professional Evaluation" -or
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 10 Professional" -or
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 11 Home Evaluation" -or
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 11 Home" -or
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 11 Professional Evaluation" -or
(Get-WmiObject -class Win32_OperatingSystem).Caption -ne "Microsoft Windows 11 Professional") {
    [AuditTest] @{
        Id = "3.1.1_1"
