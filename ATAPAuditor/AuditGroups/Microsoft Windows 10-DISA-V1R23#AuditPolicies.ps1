...
[AuditTest] @{
    Id = "V-63431 + V-63435"
    Task = "The system must be configured to audit Account Logon - Credential Validation failures. The system must be configured to audit Account Logon - Credential Validation successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63445"
    Task = "The system must be configured to audit Account Management - Security Group Management successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63447 + V-63449"
    Task = "The system must be configured to audit Account Management - User Account Management failures. The system must be configured to audit Account Management - User Account Management successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63451"
    Task = "The system must be configured to audit Detailed Tracking - PNP Activity successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63453"
    Task = "The system must be configured to audit Detailed Tracking - Process Creation successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63457"
    Task = "The system must be configured to audit Logon/Logoff - Group Membership successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63459"
    Task = "The system must be configured to audit Logon/Logoff - Logoff successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63463 + V-63467"
    Task = "The system must be configured to audit Logon/Logoff - Logon failures. The system must be configured to audit Logon/Logoff - Logon successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63469"
    Task = "The system must be configured to audit Logon/Logoff - Special Logon successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63471 + V-63473"
    Task = "The system must be configured to audit Object Access - Removable Storage failures. The system must be configured to audit Object Access - Removable Storage successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63479"
    Task = "The system must be configured to audit Policy Change - Audit Policy Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63481"
    Task = "The system must be configured to audit Policy Change - Authentication Policy Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63483 + V-63487"
    Task = "The system must be configured to audit Privilege Use - Sensitive Privilege Use failures. The system must be configured to audit Privilege Use - Sensitive Privilege Use successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63491"
    Task = "The system must be configured to audit System - IPSec Driver failures."
    Test = {
...
[AuditTest] @{
    Id = "V-63499 + V-63503"
    Task = "The system must be configured to audit System - Other System Events successes. The system must be configured to audit System - Other System Events failures."
    Test = {
...
[AuditTest] @{
    Id = "V-63507"
    Task = "The system must be configured to audit System - Security State Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63513"
    Task = "The system must be configured to audit System - Security System Extension successes."
    Test = {
...
[AuditTest] @{
    Id = "V-63515 + V-63517"
    Task = "The system must be configured to audit System - System Integrity failures. The system must be configured to audit System - System Integrity successes."
    Test = {
...
[AuditTest] @{
    Id = "V-71759"
    Task = "The system must be configured to audit Logon/Logoff - Account Lockout failures."
    Test = {
...
[AuditTest] @{
    Id = "V-71761"
    Task = "The system must be configured to audit Policy Change - Authorization Policy Change successes."
    Test = {
...
[AuditTest] @{
    Id = "V-74409 + V-74411"
    Task = "Windows 10 must be configured to audit Object Access - Other Object Access Events failures. Windows 10 must be configured to audit Object Access - Other Object Access Events successes."
    Test = {
...
[AuditTest] @{
    Id = "V-74721 + V-75027"
    Task = "Windows 10 must be configured to audit Object Access - File Share successes. Windows 10 must be configured to audit Object Access - File Share failures."
    Test = {
...
[AuditTest] @{
    Id = "V-99541 + V-99543"
    Task = "Windows 10 must be configured to audit other Logon/Logoff Events Failures. Windows 10 must be configured to audit other Logon/Logoff Events Successes."
    Test = {
...
[AuditTest] @{
    Id = "V-99545"
    Task = "Windows 10 must be configured to audit Detailed File Share Failures."
    Test = {
...
[AuditTest] @{
    Id = "V-99547 + V-99549"
    Task = "Windows 10 must be configured to audit MPSSVC Rule-Level Policy Change Successes. Windows 10 must be configured to audit MPSSVC Rule-Level Policy Change Failures."
    Test = {
...
[AuditTest] @{
    Id = "V-99551 + V-99553"
    Task = "Windows 10 must be configured to audit Other Policy Change Events Successes. Windows 10 must be configured to audit Other Policy Change Events Failures."
    Test = {
