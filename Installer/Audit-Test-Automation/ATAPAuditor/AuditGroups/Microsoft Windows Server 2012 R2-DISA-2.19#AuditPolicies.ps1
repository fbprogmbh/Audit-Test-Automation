...
[AuditTest] @{
    Id = "V-26529 + V-26530"
    Task = "The system must be configured to audit Account Logon - Credential Validation successes. The system must be configured to audit Account Logon - Credential Validation failures."
    Test = {
...
[AuditTest] @{
    Id = "V-26533"
    Task = "The system must be configured to audit Account Management - Other Account Management Events successes."
    Test = {
...
[AuditTest] @{
    Id = "V-26537 + V-26538"
    Task = "The system must be configured to audit Account Management - User Account Management successes. The system must be configured to audit Account Management - User Account Management failures."
    Test = {
...
[AuditTest] @{
    Id = "V-26541 + V-26542"
    Task = "The system must be configured to audit Logon/Logoff - Logon successes. The system must be configured to audit Logon/Logoff - Logon failures."
    Test = {
...
[AuditTest] @{
    Id = "V-26546 + V-26547"
    Task = "The system must be configured to audit Policy Change - Audit Policy Change successes. The system must be configured to audit Policy Change - Audit Policy Change failures."
    Test = {
...
[AuditTest] @{
    Id = "V-26549 + V-26550"
    Task = "The system must be configured to audit Privilege Use - Sensitive Privilege Use successes. The system must be configured to audit Privilege Use - Sensitive Privilege Use failures."
    Test = {
...
[AuditTest] @{
    Id = "V-26551 + V-26552"
    Task = "The system must be configured to audit System - IPsec Driver successes. The system must be configured to audit System - IPsec Driver failures."
    Test = {
...
[AuditTest] @{
    Id = "V-26557 + V-26558"
    Task = "The system must be configured to audit System - System Integrity successes. The system must be configured to audit System - System Integrity failures."
    Test = {
...
[AuditTest] @{
    Id = "V-40200 + V-40202"
    Task = "The system must be configured to audit Object Access - Central Access Policy Staging failures. The system must be configured to audit Object Access - Central Access Policy Staging successes."
    Test = {
        # Get the audit policy for the subcategory Central Policy Staging
        $subCategoryGUID = Get-AuditPolicySubcategoryGUID -Subcategory "Central Policy Staging"
        
        if ([string]::IsNullOrEmpty($subCategoryGUID)) {
            return @{
                Message = "Cannot get Subcategory 'Central Policy Staging'"
                Status = "None"
            }
        }
...
[AuditTest] @{
    Id = "V-78057 + V-78059"
    Task = "Windows Server 2012/2012 R2 must be configured to audit Logon/Logoff - Account Lockout successes. Windows Server 2012/2012 R2 must be configured to audit Logon/Logoff - Account Lockout failures."
    Test = {
...
[AuditTest] @{
    Id = "V-78061 + V-78063"
    Task = "Windows Server 2012/2012 R2 must be configured to audit System - Other System Events successes. Windows Server 2012/2012 R2 must be configured to audit System - Other System Events failures."
    Test = {
